...
module.exports.override = function(Internationalization, Messenger) {
  ...
  Internationalization.prototype.languages = function(parent, callback) {
    ...
    try {
      ...
      if (languages.length)
        return callOrThrow(this, callback, null, slice.call(languages));
        ...
        files.forEach(function (file) {
          fs.stat(Path.join(dir, file), function (err, stats) {
            ...
            if (++count === files.length) {
              languages.sort();
              callOrThrow(that, callback, null, slice.call(languages));
            }
          });
        });
      });
  ...
  Internationalization.prototype.languagesSync = function(parent) {
    ...
    if (languages.length) return slice.call(languages);
