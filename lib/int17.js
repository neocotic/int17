...
(function () {
  ...
  SUBS_ATTRIBUTES.push(DATA_ATTRIBUTE_PREFIX + SUBS_ATTRIBUTES[0]);
  ...
  function validateMessage(messageName, message) {
    ...
    if (message.hasOwnProperty('placeholders') && typeof message.placeholders !== 'object') {
  ...
  var handlers = {
    ...
    , attributes = (function () {
        ...
        for (attribute in handlers) {
          ...
          dataAttribute           = DATA_ATTRIBUTE_PREFIX + attribute;
  ...
  Internationalization.prototype.get = function(name) {
    ...
    return message && substitute(message, this.messenger.optimize, subs);
  };
